...
import { VehicleVolumeItem } from '../models/vehicle-volume-totals.model';
import { FuelPriceAverageItem } from '../models/fuel-price-averages.model';
import { FuelRecord, FuelRecordWithTotal } from '../../../shared/models/fuel-records.model';
import { DashboardFilters, FilterOption } from '../models/dashboard-filter.model';
import { VolumeByStateItem } from '../models/volume-by-state.model';
import { TopStationItem } from '../models/top-station.model';
